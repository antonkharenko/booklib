...
public class AccountServiceIT extends AbstractServiceIT {
	...
	public void testUpdateAccount() {
		...
		final UpdateAccountRequest updateAccountRequest = UpdateAccountRequest.newBuilder()
		...
		// When
		final UserResponse updatedUserResponse = request("/api/account", "POST", updateAccountRequest, UserResponse.class, userResponse.getApiKey());
		...
		assertEquals(updateAccountRequest.getUsername(), updatedUserResponse.getUsername());
		assertEquals(updateAccountRequest.getFirstName(), updatedUserResponse.getFirstName());
		assertEquals(updateAccountRequest.getLastName(), updatedUserResponse.getLastName());
	}
