...
/**
 * A Volume represents information that Google Books API returns about a book or a magazine. It
 * contains metadata, such as title and author, as well as personalized data, such as whether or not
